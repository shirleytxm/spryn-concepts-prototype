import svgPaths from "./svg-sduln9tbug";
...
function Frame33() {
  return (
    <div className="bg-[#fff8f8] content-stretch flex items-center justify-center p-[4px] relative rounded-[4px] shrink-0">
      ...
      <p className="font-['Courier_New:Bold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#7e2f2f] text-[10px] whitespace-nowrap">src/auth/sso.ts</p>
    </div>
  );
}
    ...
    <div className="relative rounded-[4px] shrink-0 w-full" data-name="logItem3">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-start pl-[36px] py-[8px] relative w-full">
          <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[1.5] min-h-px min-w-px not-italic relative text-[11px] text-black">Analysed existing SSO provider integration</p>
        </div>
      </div>
    </div>
  );
...
function Frame35() {
  return (
    <div className="bg-[#fff8f8] content-stretch flex items-center justify-center p-[4px] relative rounded-[4px] shrink-0">
      <div aria-hidden="true" className="absolute border border-[#ffd0d0] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <p className="font-['Courier_New:Bold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#7e2f2f] text-[10px] whitespace-nowrap">src/auth/magic-link.ts</p>
    </div>
  );
}
...
function LogItem2() {
  return (
    <div className="relative rounded-[4px] shrink-0 w-full" data-name="logItem3">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-start pl-[36px] py-[8px] relative w-full">
          <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[1.5] min-h-px min-w-px not-italic relative text-[11px] text-black">Reviewed token generation and expiry logic</p>
        </div>
      </div>
    </div>
  );
    ...
    <div className="relative rounded-[4px] shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center pl-[36px] py-[8px] relative w-full">
          <p className="font-['Courier_New:Bold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#1d4ed8] text-[12px] whitespace-nowrap">bash npm run test:auth</p>
        </div>
      </div>
    </div>
  );
...
function CodeBox() {
  return (
    <div className="bg-[#1e1e2e] flex-[1_0_0] min-h-px min-w-px relative rounded-[6px]" data-name="codeBox">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col font-['Courier_New:Bold',sans-serif] gap-[8px] items-start leading-[normal] not-italic px-[10px] py-[8px] relative text-[10px] w-full">
          <p className="relative shrink-0 text-[#4ade80] whitespace-pre">{`PASS  src/auth/sso.test.ts`}</p>
          <p className="relative shrink-0 text-[#4ade80] whitespace-pre">{`PASS  src/auth/session.test.ts`}</p>
          <p className="relative shrink-0 text-[#9ca3af] whitespace-nowrap">Tests: 12 passed, 12 total</p>
        </div>
      </div>
    </div>
  );
...
function Frame36() {
  return (
    <div className="bg-[#fff8f8] content-stretch flex items-center justify-center p-[4px] relative rounded-[4px] shrink-0">
      <div aria-hidden="true" className="absolute border border-[#ffd0d0] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <p className="font-['Courier_New:Bold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#7e2f2f] text-[10px] whitespace-nowrap">src/auth/sso-provider.ts</p>
    </div>
  );
}
...
function LogItem4() {
  return (
    <div className="relative rounded-[4px] shrink-0 w-full" data-name="logItem3">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[10px] items-start pl-[36px] py-[8px] relative w-full">
          <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[1.5] min-h-px min-w-px not-italic relative text-[11px] text-black">Implemented OAuth2 callback handler and session binding</p>
        </div>
      </div>
    </div>
  );
...
function BackgroundBorder3() {
  return (
    <div className="absolute aspect-[16/10] content-stretch flex flex-col items-start justify-center left-0 overflow-clip right-0 top-[-2px]" data-name="Background+Border">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgScreenshot20260224At103645Pm1} />
      <SignupFlow />
      <Container48 />
    </div>
...
function PreviewThumb() {
  return (
    <div className="bg-[#d9d9de] h-[123px] overflow-clip relative rounded-[4px] shrink-0 w-[200px]" data-name="previewThumb">
      <BackgroundBorder3 />
    </div>
  );
}
    ...
    <div className="relative rounded-[4px] shrink-0 w-full" data-name="logItem3">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[10px] items-start pl-[36px] py-[8px] relative w-full">
          <PreviewThumb />
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#737373] text-[10px] whitespace-nowrap">Preview screenshot captured</p>
        </div>
      </div>
    </div>
  );
...
function Frame43() {
  return (
    <div className="relative rounded-[4px] shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center pl-[36px] py-[8px] relative w-full">
          <p className="font-['Courier_New:Bold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#1d4ed8] text-[12px] whitespace-nowrap">bash npm run build</p>
        </div>
      </div>
    </div>
  );
...
function LogItem6() {
  return (
    <div className="relative rounded-[4px] shrink-0 w-full" data-name="logItem3">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[10px] items-start pl-[36px] py-[8px] relative w-full">
          <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[1.5] min-h-px min-w-px not-italic relative text-[11px] text-black">Building project…</p>
        </div>
      </div>
    </div>
  );
...
function LogItem7() {
  return (
    <div className="relative rounded-[4px] shrink-0 w-full" data-name="logItem3">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[10px] items-start pl-[36px] py-[8px] relative w-full">
          <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[1.5] min-h-px min-w-px not-italic relative text-[11px] text-black">Compiled build</p>
        </div>
      </div>
    </div>
  );
...
function Frame37() {
  return (
    <div className="bg-[#fff8f8] content-stretch flex items-center justify-center p-[4px] relative rounded-[4px] shrink-0">
      <div aria-hidden="true" className="absolute border border-[#ffd0d0] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <p className="font-['Courier_New:Bold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#7e2f2f] text-[10px] whitespace-nowrap">src/auth/tests/sso.test.ts</p>
    </div>
  );
}
...
function Frame47() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-0 pb-[16px] pt-[6px] px-[20px] top-[40px] w-[611px]">
      <Frame41 />
    </div>
  );
}
...
export default function StoryDetailDev() {
  return (
    <div className="bg-[#f2f2f2] relative size-full" data-name="Story Detail - Dev">
      <Sidebar />
      <MainContentArea />
      <Frame21 />
