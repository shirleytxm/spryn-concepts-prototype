import svgPaths from "./svg-gbwabtdgd9";
...
function FrameMN() {
  return (
    <div className="bg-[#1e1e2e] flex-[1_0_0] min-h-px min-w-px relative rounded-[6px]" data-name="Frame mN088">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[3px] items-start leading-[normal] not-italic px-[10px] py-[8px] relative text-[10px] w-full">
...
function LogItem3() {
  return (
    <div className="relative rounded-[4px] shrink-0 w-full" data-name="logItem3">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[10px] items-start pl-[36px] py-[8px] relative w-full">
          <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[1.5] min-h-px min-w-px not-italic relative text-[11px] text-black">Simulating VoiceOver navigation through all login screens. Verifying focus order and ARIA labels match design spec.</p>
        </div>
      </div>
    </div>
  );
...
function Frame46() {
  return (
    <div className="relative rounded-[4px] shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center pl-[36px] py-[8px] relative w-full">
          <p className="font-['Courier_New:Bold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#1d4ed8] text-[12px] whitespace-nowrap">AC4 VoiceOver test failed</p>
        </div>
      </div>
    </div>
  );
...
function LogItem4() {
  return (
    <div className="relative rounded-[4px] shrink-0 w-full" data-name="logItem3">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[10px] items-start pl-[36px] py-[8px] relative w-full">
          <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[1.5] min-h-px min-w-px not-italic relative text-[11px] text-black">Focus ring skips the PIN fallback button entirely on error-fallback screen. Reproducible on iOS 17 and 18. Filed bug BIO-47.</p>
        </div>
      </div>
    </div>
  );
...
function FrameQiMna() {
  return (
    <div className="bg-[#1e1e2e] flex-[1_0_0] min-h-px min-w-px relative rounded-[6px]" data-name="Frame QiMNA">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[3px] items-start leading-[normal] not-italic px-[10px] py-[8px] relative text-[10px] w-full">
          <p className="font-['Courier_New:Bold','Noto_Sans_Symbols2:Regular',sans-serif] relative shrink-0 text-[#4ade80] whitespace-pre">{`✓  AC1: Biometric prompt              PASS`}</p>
          <p className="font-['Courier_New:Bold','Noto_Sans_Symbols2:Regular',sans-serif] relative shrink-0 text-[#4ade80] whitespace-pre">{`✓  AC2: PIN fallback flow              PASS`}</p>
          <p className="font-['Courier_New:Bold','Noto_Sans_Symbols2:Regular',sans-serif] relative shrink-0 text-[#4ade80] whitespace-pre">{`✓  AC3: Session persistence            PASS`}</p>
          <p className="font-['Courier_New:Bold','Noto_Sans_Symbols2:Regular',sans-serif] relative shrink-0 text-[#f87171] whitespace-pre">{`✗  AC4: VoiceOver - focus order skip   FAIL`}</p>
          <p className="font-['Courier_New:Regular',sans-serif] relative shrink-0 text-[#9ca3af] whitespace-nowrap">&nbsp;</p>
          <p className="font-['Courier_New:Bold',sans-serif] relative shrink-0 text-[#f87171] whitespace-pre">{`  3 passed  ·  1 failed  ·  BUG: BIO-47`}</p>
        </div>
      </div>
    </div>
  );
...
function Frame7LGer() {
  return (
    <div className="bg-[#ffefef] flex-[1_0_0] min-h-px min-w-px relative rounded-[6px]" data-name="Frame 7lGER">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[8px] items-start not-italic px-[12px] py-[8px] relative text-[#d10f19] text-[11px] w-full">
          <p className="font-['Inter:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 whitespace-nowrap">AC4: VoiceOver — FAIL</p>
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[1.5] min-w-full relative shrink-0 w-[min-content]">Focus order skips the PIN fallback button on error-fallback screen. Screen reader users cannot recover from failed biometric.</p>
        </div>
      </div>
    </div>
  );
...
function Frame48() {
  return (
    <div className="relative rounded-[4px] shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center pl-[36px] py-[8px] relative w-full">
          <p className="font-['Courier_New:Bold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#1d4ed8] text-[12px] whitespace-nowrap">calling Dev agent</p>
        </div>
      </div>
    </div>
  );
...
function LogItem15() {
  return (
    <div className="relative rounded-[4px] shrink-0 w-full" data-name="logItem3">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-start pl-[36px] py-[8px] relative w-full">
          <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[1.5] min-h-px min-w-px not-italic relative text-[12px] text-black">BIO-47 fix is ready — awaiting [username]’s go-ahead</p>
        </div>
      </div>
    </div>
  );
...
function LogItem16() {
  return (
    <div className="relative rounded-[4px] shrink-0 w-full" data-name="logItem3">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-start pl-[36px] py-[8px] relative w-full">
          <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[1.5] min-h-px min-w-px not-italic relative text-[12px] text-black">tabIndex fix is staged and tested locally. 2-line change. I can ship it in 5 minutes once [username] gives the go-ahead.</p>
        </div>
      </div>
    </div>
  );
...
function Frame42() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0">
      ...
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[normal] not-italic relative shrink-0 text-[#737373] text-[12px] whitespace-nowrap">(weighing in on severity)</p>
    </div>
  );
}
...
function LogItem18() {
  return (
    <div className="relative rounded-[4px] shrink-0 w-full" data-name="logItem3">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[10px] items-start pl-[36px] py-[8px] relative w-full">
          <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[1.5] min-h-px min-w-px not-italic relative text-[12px] text-black">This is P1 severity — WCAG 2.1 AA compliance is in our NFRs. Recommending we fix it in this sprint rather than accrue accessibility debt.</p>
        </div>
      </div>
    </div>
  );
...
function Container51() {
  return (
    <div className="relative shrink-0" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center relative">
        <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[#805c15] text-[12px] whitespace-nowrap">
          <p className="leading-[1.5]">Response Needed</p>
        </div>
      </div>
    </div>
  );
...
function ArtifactCard() {
  return (
    <div className="bg-[#fffae5] relative rounded-[8px] shrink-0 w-full" data-name="Artifact Card">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[12px] items-start p-[17px] relative w-full">
          <Container51 />
          <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-w-full not-italic relative shrink-0 text-[#111827] text-[12px] w-[min-content]">
            <p className="leading-[1.5]">All agents are paused waiting for your decision. Fix in sprint (recommended) or defer to BIO-47 follow-up story?</p>
          </div>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[#f59e0b] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
}
...
function CardActionButton() {
  return (
    <div className="bg-white relative rounded-[4px] shrink-0 w-full" data-name="Card Action → Button">
      <div aria-hidden="true" className="absolute border border-[#ccc] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8.01px] items-center px-[14px] py-[10px] relative w-full">
          <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-black text-center whitespace-nowrap">
            <p className="leading-[20px]">Fix in sprint</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="bg-white relative rounded-[4px] shrink-0 w-full" data-name="Card Action → Button">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8.01px] items-center px-[14px] py-[10px] relative w-full">
          <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-black text-center whitespace-nowrap">
            <p className="leading-[20px]">Defer to BIO-47 follow up story</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Background+HorizontalBorder">
      ...
      <div className="content-stretch flex flex-col gap-[12px] items-start p-[16px] relative w-full">
        <CardActionButton />
        <CardActionButton1 />
        <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#737373] text-[12px] whitespace-nowrap">
...
export default function StoryDetailHumanResponseRequired() {
  return (
    <div className="bg-[#f2f2f2] relative size-full" data-name="Story Detail - Human Response Required">
      <Sidebar />
      <MainContentArea />
      <Frame25 />
