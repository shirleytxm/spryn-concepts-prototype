import svgPaths from "./svg-6ajsvyfjpt";
...
function Frame18() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] items-start left-[28px] top-[-539px] w-[484px]">
      ...
      <Frame17 />
      <div className="font-['Inter:Regular',sans-serif] font-normal leading-[32px] not-italic relative shrink-0 text-[0px] text-black w-full" style={{ fontFeatureSettings: "'kern' 0" }}>
        <p className="font-['Inter:Bold',sans-serif] font-bold mb-[8px] text-[18px]">Story 3.2: AI Screen Prompts Gevneration</p>
        <p className="text-[16px]">As a user, I want the system to generate AI-powered screen prompts derived from my UX Spec, PRD, and Epics, So that I have actionable descriptions for creating screen designs for each feature.</p>
      </div>
      <div className="font-['Inter:Regular',sans-serif] font-normal leading-[0] not-italic relative shrink-0 text-[0px] text-[16px] text-black w-full" style={{ fontFeatureSettings: "'kern' 0" }}>
        <p className="font-['Inter:Bold',sans-serif] font-bold leading-[32px] mb-[8px]">Acceptance Criteria:</p>
...
function Frame5() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Frame">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Frame">
          <path d={svgPaths.p1328f400} id="Vector" stroke="var(--stroke-0, #737373)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.3" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="relative rounded-[4px] shrink-0 w-full">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex gap-[10px] items-center justify-center px-[8px] py-[6px] relative w-full">
          <Frame5 />
          <div className="flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-h-px min-w-px not-italic overflow-hidden relative text-[#404040] text-[14px] text-ellipsis whitespace-nowrap">
            <p className="leading-[20px] overflow-hidden">3-1_reference-screen-in-line-for-epic-association</p>
          </div>
        </div>
      </div>
    </div>
        ...
        <div className="content-stretch flex flex-col gap-[4px] items-start px-[16px] py-[12px] relative w-full">
          <div className="bg-white relative rounded-[4px] shrink-0 w-full" data-name="Input Field">
            <div className="overflow-clip rounded-[inherit] size-full">
              <div className="content-stretch flex gap-[8px] items-start px-[8px] py-[6px] relative w-full">
                <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#404040] text-[14px] whitespace-nowrap">
                  <p className="leading-[20px]">3-1_screen-prompt-artifact_prompt-modal</p>
                </div>
              </div>
            </div>
...
export default function Component31AssetsDrawerRenameInputField() {
  return (
    <div className="bg-white relative size-full" data-name="3-1_assets-drawer_rename-input-field">
      <Container />
      <Sidebar />
    </div>
  );
