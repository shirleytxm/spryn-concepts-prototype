import svgPaths from "./svg-m9k7foxrki";
    ...
    <div className="relative rounded-[4px] shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center pl-[36px] py-[8px] relative w-full">
          <p className="font-['Courier_New:Bold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#1d4ed8] text-[12px] whitespace-nowrap">started implementation scaffolding</p>
        </div>
      </div>
    </div>
  );
    ...
    <div className="relative rounded-[4px] shrink-0 w-full" data-name="logItem3">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-start pl-[36px] py-[8px] relative w-full">
          <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[1.5] min-h-px min-w-px not-italic relative text-[11px] text-black">Cloning story branch and setting up auth module. Reading manifest.json for screen list before wiring components.</p>
        </div>
      </div>
    </div>
  );
...
function FramePtRwS() {
  return (
    <div className="bg-[#1e1e2e] flex-[1_0_0] min-h-px min-w-px relative rounded-[6px]" data-name="Frame PtRwS">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[3px] items-start leading-[normal] not-italic px-[10px] py-[8px] relative text-[10px] w-full">
          <p className="font-['Courier_New:Bold',sans-serif] relative shrink-0 text-[#9ca3af] whitespace-nowrap">$ npx spryn scaffold --story biometric-auth</p>
          <p className="font-['Courier_New:Bold',sans-serif] relative shrink-0 text-[#facc15] whitespace-pre">{`  Reading manifest.json…`}</p>
          <p className="font-['Courier_New:Bold',sans-serif] relative shrink-0 text-[#9ca3af] whitespace-pre">{`  Expected: 4 screens`}</p>
          <p className="font-['Courier_New:Bold',sans-serif] relative shrink-0 text-[#f87171] whitespace-pre">{`  Found:    2 screens`}</p>
          <p className="font-['Courier_New:Bold','Noto_Sans_Symbols2:Regular',sans-serif] relative shrink-0 text-[#f87171] whitespace-pre">{`✗  Missing: error-fallback.pen`}</p>
          <p className="font-['Courier_New:Bold','Noto_Sans_Symbols2:Regular',sans-serif] relative shrink-0 text-[#f87171] whitespace-pre">{`✗  Missing: pin-entry.pen`}</p>
          <p className="font-['Courier_New:Bold',sans-serif] relative shrink-0 text-[#f87171] whitespace-pre">{`  Scaffold aborted — resolve missing screens`}</p>
        </div>
      </div>
    </div>
  );
...
function LogItem3() {
  return (
    <div className="relative rounded-[4px] shrink-0 w-full" data-name="logItem3">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-start pl-[36px] py-[8px] relative w-full">
          <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[1.5] min-h-px min-w-px not-italic relative text-[11px] text-black">Scaffold failed — 2 screens are missing from the manifest. Pinging UX to regenerate error-fallback.pen and pin-entry.pen.</p>
        </div>
      </div>
    </div>
  );
...
function Frame35() {
  return (
    <div className="relative rounded-[4px] shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center pl-[36px] py-[8px] relative w-full">
          <p className="font-['Courier_New:Bold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#1d4ed8] text-[12px] whitespace-nowrap">reported missing screens to UX agent</p>
        </div>
      </div>
    </div>
  );
...
function LogItem5() {
  return (
    <div className="relative rounded-[4px] shrink-0 w-full" data-name="logItem3">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[10px] items-start pl-[36px] py-[8px] relative w-full">
          <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[1.5] min-h-px min-w-px not-italic relative text-[12px] text-black">Missing screens acknowledged.</p>
        </div>
      </div>
    </div>
  );
...
function LogItem6() {
  return (
    <div className="relative rounded-[4px] shrink-0 w-full" data-name="logItem3">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[10px] items-start pl-[36px] py-[8px] relative w-full">
          <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[1.5] min-h-px min-w-px not-italic relative text-[12px] text-black">Found the issue — both screens were skipped due to a naming collision in the batch script. Fixing and regenerating.</p>
        </div>
      </div>
    </div>
  );
...
function Frame37() {
  return (
    <div className="relative rounded-[4px] shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center pl-[36px] py-[8px] relative w-full">
          <p className="font-['Courier_New:Bold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#1d4ed8] text-[12px] whitespace-nowrap">regenerating missing screens</p>
        </div>
      </div>
    </div>
  );
...
function LogItem7() {
  return (
    <div className="relative rounded-[4px] shrink-0 w-full" data-name="logItem3">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[10px] items-start pl-[36px] py-[8px] relative w-full">
          <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[1.5] min-h-px min-w-px not-italic relative text-[12px] text-black">Running targeted generate for error-fallback.pen and pin-entry.pen with collision fix applied.</p>
        </div>
      </div>
    </div>
  );
...
function Frame42() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[12px] items-start left-0 pb-[16px] pt-[6px] px-[20px] top-[40px] w-[611px]">
      <Frame36 />
      <Frame38 />
    </div>
  );
...
export default function StoryDetailDevMissingScreens() {
  return (
    <div className="bg-[#f2f2f2] relative size-full" data-name="Story Detail - Dev Missing Screens">
      <Sidebar />
      <MainContentArea />
      <Frame21 />
