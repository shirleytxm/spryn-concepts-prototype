import svgPaths from "./svg-ijq15hxrpp";
...
function Frame18() {
  return (
    <div className="absolute content-stretch flex gap-[24px] items-center justify-end right-[21px] top-[20px]">
      <Button2 />
...
function Overlay1() {
  return (
    <div className="absolute bg-[rgba(0,0,0,0.8)] h-[1005px] left-0 top-0 w-[1441px]" data-name="overlay">
      <Frame18 />
      <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[923px] left-[calc(50%-0.5px)] shadow-[4px_4px_8px_0px_rgba(0,0,0,0.14)] top-1/2 w-[226px]" data-name="image 35">
