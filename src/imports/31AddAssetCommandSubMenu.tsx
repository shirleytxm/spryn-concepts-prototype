import svgPaths from "./svg-4lwfa2gjc8";
...
function Frame16() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] items-start left-[28px] not-italic text-black top-[-539px] w-[484px]">
      <div className="font-['Inter:Regular',sans-serif] font-normal leading-[32px] min-w-full relative shrink-0 text-[0px] w-[min-content]" style={{ fontFeatureSettings: "'kern' 0" }}>
      ...
      <div className="font-['Inter:Regular',sans-serif] font-normal leading-[0] min-w-full relative shrink-0 text-[0px] text-[16px] w-[min-content]" style={{ fontFeatureSettings: "'kern' 0" }}>
      ...
      <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[16px] whitespace-nowrap">
...
function Frame18() {
  return (
    <div className="bg-white content-stretch flex items-center px-[12px] py-[6px] relative shrink-0 w-[290px]">
...
function Frame() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Frame">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Frame">
          <path d={svgPaths.p1328f400} id="Vector" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.3" />
        </g>
      </svg>
    </div>
  );
...
function Option() {
  return (
    <div className="bg-[#feecee] relative rounded-[4px] shrink-0 w-full" data-name="Option">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[12px] items-center px-[16px] py-[12px] relative w-full">
          ...
          <div className="flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-h-px min-w-px not-italic overflow-hidden relative text-[14px] text-black text-ellipsis whitespace-nowrap">
            <p className="leading-[20px] overflow-hidden">3-1_screen-prompt-artifact_prompt-modal</p>
          </div>
        </div>
      </div>
    </div>
...
function ListboxSuggestions() {
  return (
    <div className="content-stretch flex flex-col items-start p-[12px] relative shrink-0 w-[289px]" data-name="Listbox - Suggestions">
      <Option />
      <Option1 />
    </div>
  );
...
function Tooltip() {
  return (
    <div className="absolute bg-white left-[28px] rounded-[8px] top-[297px]" data-name="Tooltip">
      <div className="content-stretch flex flex-col items-end overflow-auto relative">
        <Frame18 />
        <ListboxSuggestions />
      </div>
      <div aria-hidden="true" className="absolute border border-[#ccc] border-solid inset-0 pointer-events-none rounded-[8px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.05),0px_4px_6px_-8px_rgba(0,0,0,0.05)]" />
    </div>
  );
}
...
function EditorBody() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px min-w-px relative rounded-bl-[8px] rounded-br-[8px] w-full" data-name="editor-body">
      <div className="overflow-auto size-full">
        <div className="content-stretch flex flex-col gap-[24px] items-start p-[28px] relative size-full">
          <Frame16 />
          <Tooltip />
        </div>
      </div>
...
function Editor1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-[984px] items-center min-h-px min-w-px relative" data-name="editor">
...
function Editor() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-full" data-name="editor">
...
export default function Component31AddAssetCommandSubMenu() {
  return (
    <div className="bg-white relative size-full" data-name="3-1_add-asset-command-sub-menu">
      <Container />
      <Frame17 />
    </div>
  );
