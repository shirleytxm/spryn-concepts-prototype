import svgPaths from "./svg-lq4fzjk6ff";
...
function Frame18() {
  return (
    <div className="content-stretch flex gap-[10px] items-center justify-center relative shrink-0">
      <Frame1 />
      <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#0050c9] text-[16px] whitespace-nowrap">
        <p className="leading-[1.5]">3-1_reference-screen-in-line-for-epic-association</p>
      </div>
    </div>
  );
}
...
function Frame19() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[4px] items-start left-0 top-[808px] w-[484px]">
      <Frame17 />
      <Frame18 />
    </div>
  );
...
function Frame20() {
  return (
    <div className="absolute h-[1469px] left-[28px] top-[-539px] w-[484px]">
      <div className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[32px] left-0 not-italic text-[0px] text-black top-0 w-[484px]" style={{ fontFeatureSettings: "'kern' 0" }}>
      ...
      <div className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[32px] left-0 not-italic text-[0px] text-black top-[199px] w-[484px]" style={{ fontFeatureSettings: "'kern' 0" }}>
      ...
      <div className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[0] left-0 not-italic text-[0px] text-[16px] text-black top-[392px] w-[484px]" style={{ fontFeatureSettings: "'kern' 0" }}>
      ...
      <Frame19 />
      <div className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[32px] left-0 not-italic text-[0px] text-black top-[884px] w-[484px]" style={{ fontFeatureSettings: "'kern' 0" }}>
        <p className="font-['Inter:Bold',sans-serif] font-bold mb-[8px] text-[18px]">Story 3.2: AI Screen Prompts Generation</p>
        <p className="text-[16px]">As a user, I want the system to generate AI-powered screen prompts derived from my UX Spec, PRD, and Epics, So that I have actionable descriptions for creating screen designs for each feature.</p>
      </div>
      <div className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[0] left-0 not-italic text-[0px] text-[16px] text-black top-[1077px] w-[484px]" style={{ fontFeatureSettings: "'kern' 0" }}>
        <p className="font-['Inter:Bold',sans-serif] font-bold leading-[32px] mb-[8px]">Acceptance Criteria:</p>
        <p>
          <span className="font-['Inter:Bold',sans-serif] font-bold leading-[32px] not-italic">Given</span>
          <span className="leading-[32px]">
...
function Container() {
  return (
    <div className="absolute content-stretch flex h-[900px] items-center justify-between left-[312px] right-0 top-0" data-name="Container">
      <EditorPanel />
      <ChatPanel />
    </div>
  );
...
function Frame6() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute left-1/2 size-[24px] top-1/2" data-name="Frame">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Frame">
          <path d={svgPaths.p1beb9e00} id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
        </g>
      </svg>
    </div>
  );
...
function Projects1() {
  return (
    <div className="opacity-50 relative rounded-[6px] shrink-0 size-[40px]" data-name="Projects">
      <Frame6 />
    </div>
  );
}
...
function Sidebar() {
  return (
    <div className="absolute content-stretch flex h-[900px] items-center left-0 top-0" data-name="sidebar">
      <Sidebar1 />
...
export default function Component22ArtifactDrawerOpen() {
  return (
    <div className="bg-white relative size-full" data-name="2-2_artifact-drawer-open">
      <Container />
      <Sidebar />
    </div>
  );
