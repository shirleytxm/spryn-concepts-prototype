import svgPaths from "./svg-5pem8h51xv";
...
function FrameEjSuh() {
  return <div className="absolute bg-[#f59e0b] h-[6px] left-0 rounded-[3px] top-0 w-[191px]" data-name="Frame ejSuh" />;
}
...
function Frame22() {
  return (
    <div className="content-stretch flex gap-[10px] items-center relative shrink-0">
      <ProgTrack />
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[#805c15] text-[12px] whitespace-nowrap">48%</p>
    </div>
  );
}
...
function BannerText() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-h-px min-w-px overflow-clip relative text-[14px]" data-name="bannerText">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 text-[#065f46]">Ready to Start Implementation</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[#008330]">All stories and screens reviewed by agents — ready to commence development workflow</p>
    </div>
  );
}
...
function Btn() {
  return (
    <div className="bg-[#16a34a] content-stretch flex flex-col items-center justify-center overflow-clip px-[20px] py-[12px] relative rounded-[8px] shrink-0" data-name="btn">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[14px] text-white whitespace-nowrap">Start Development</p>
    </div>
  );
}
...
export default function MilestoneOverviewModalCompletedAllScreens() {
  return (
    <div className="bg-[#f2f2f2] relative size-full" data-name="Milestone Overview Modal - Completed All Screens">
      <Sidebar />
      <MainContentArea />
      <Frame19 />
