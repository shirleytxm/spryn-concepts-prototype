import svgPaths from "./svg-rfe2pr066t";
...
function BackgroundBorder1() {
  return (
    <div className="bg-[#f7d3bb] content-stretch flex flex-col items-start px-[8px] py-[2px] relative rounded-[9999px] shrink-0" data-name="Background+Border">
      <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#804015] text-[12px] whitespace-nowrap">
    ...
    <div className="relative rounded-[4px] shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center pl-[36px] py-[8px] relative w-full">
          <p className="font-['Courier_New:Bold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#1d4ed8] text-[12px] whitespace-nowrap">started screen generation batch</p>
        </div>
      </div>
    </div>
  );
    ...
    <div className="relative rounded-[4px] shrink-0 w-full" data-name="logItem3">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[10px] items-start pl-[36px] py-[8px] relative w-full">
          <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[1.5] min-h-px min-w-px not-italic relative text-[12px] text-black">Running spryn generate-screens for all 4 screens in the biometric-auth flow. Expected output: .pen files with component bindings.</p>
        </div>
      </div>
    </div>
  );
...
function CodeBox() {
  return (
    <div className="bg-[#1e1e2e] flex-[1_0_0] min-h-px min-w-px relative rounded-[6px]" data-name="codeBox">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[8px] items-start leading-[normal] not-italic px-[10px] py-[8px] relative text-[10px] w-full">
          <p className="font-['Courier_New:Bold',sans-serif] relative shrink-0 text-[#9ca3af] whitespace-nowrap">$ npx spryn generate-screens --story biometric-auth --all</p>
          <p className="font-['Courier_New:Bold',sans-serif] relative shrink-0 text-[#facc15] whitespace-nowrap">Generating: login-entry.pen</p>
          <p className="font-['Courier_New:Bold','Noto_Sans_Symbols2:Regular',sans-serif] relative shrink-0 text-[#4ade80] whitespace-pre">{`login-entry.pen  created  (2.1s) ✓  `}</p>
          <p className="font-['Courier_New:Bold',sans-serif] relative shrink-0 text-[#facc15] whitespace-nowrap">Generating: biometric-prompt.pen</p>
          <p className="font-['Courier_New:Bold','Noto_Sans_Symbols2:Regular',sans-serif] relative shrink-0 text-[#4ade80] whitespace-pre">{`biometric-prompt.pen  created  (1.8s) ✓`}</p>
          <p className="font-['Courier_New:Bold',sans-serif] relative shrink-0 text-[#3b82f6] whitespace-nowrap">Generating: success-state.pen</p>
          <p className="font-['Courier_New:Bold',sans-serif] relative shrink-0 text-[#60a5fa] whitespace-nowrap">running…</p>
        </div>
      </div>
    </div>
  );
...
function Frame34() {
  return (
    <div className="relative rounded-[4px] shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center pl-[36px] py-[8px] relative w-full">
          <p className="font-['Courier_New:Bold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#1d4ed8] text-[12px] whitespace-nowrap">completed 2 of 4 screens</p>
        </div>
      </div>
    </div>
  );
...
function LogItem3() {
  return (
    <div className="relative rounded-[4px] shrink-0 w-full" data-name="logItem3">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[10px] items-start pl-[36px] py-[8px] relative w-full">
          <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[1.5] min-h-px min-w-px not-italic relative text-[12px] text-black">login-entry.pen and biometric-prompt.pen are ready. Generating success-state.pen now — ETA ~2s.</p>
        </div>
      </div>
    </div>
  );
...
function Frame31() {
  return (
    <div className="bg-[#fff8f8] content-stretch flex items-center justify-center p-[4px] relative rounded-[4px] shrink-0">
      ...
      <p className="font-['Courier_New:Bold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#7e2f2f] text-[12px] whitespace-nowrap">success-state.pen</p>
    </div>
  );
}
    ...
    <div className="relative rounded-[4px] shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center pl-[36px] py-[8px] relative w-full">
          <p className="font-['Courier_New:Bold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#1d4ed8] text-[12px] whitespace-nowrap">generating</p>
          <Frame31 />
        </div>
      </div>
    </div>
...
function LogItem4() {
  return (
    <div className="relative rounded-[4px] shrink-0 w-full" data-name="logItem3">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[10px] items-start pl-[36px] py-[8px] relative w-full">
          <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[1.5] min-h-px min-w-px not-italic relative text-[#374151] text-[12px]">Applying component bindings and layout constraints. Estimated completion in ~1 second.</p>
        </div>
      </div>
    </div>
  );
...
function DesignCard() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] h-[142px] items-start relative shrink-0 w-[192px]" data-name="Design Card 1">
      <BackgroundBorder2 />
      <Container52 />
    </div>
  );
...
function DesignCard1() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] h-[142px] items-start relative shrink-0 w-[192px]" data-name="Design Card 2">
      <BackgroundBorder3 />
      <Container54 />
    </div>
  );
...
function DesignCard2() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] h-[142px] items-start relative shrink-0 w-[192px]" data-name="Design Card 3">
      <BackgroundBorder4 />
      <Container56 />
    </div>
  );
...
function LogItem5() {
  return (
    <div className="relative rounded-[4px] shrink-0 w-full" data-name="logItem3">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[10px] items-start pl-[36px] py-[8px] relative w-full">
          <DesignCard />
          <DesignCard1 />
          <DesignCard2 />
        </div>
...
function Frame40() {
  return (
    <div className="relative shrink-0 w-full">
      <div className="content-stretch flex flex-col items-start pb-[16px] pt-[6px] px-[20px] relative w-full">
        <Frame36 />
      </div>
    </div>
  );
...
function MilestoneModal() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-white left-[calc(50%-2px)] rounded-[8px] top-[calc(50%+1px)] w-[922px]" data-name="Milestone Modal">
...
export default function StoryDetailScreenGeneration() {
  return (
    <div className="bg-[#f2f2f2] relative size-full" data-name="Story Detail - Screen Generation">
      <Sidebar />
      <MainContentArea />
      <Frame19 />
