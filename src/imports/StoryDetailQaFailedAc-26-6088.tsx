import svgPaths from "./svg-qffo3obnjr";
...
function FrameMN() {
  return (
    <div className="bg-[#1e1e2e] flex-[1_0_0] min-h-px min-w-px relative rounded-[6px]" data-name="Frame mN088">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[3px] items-start leading-[normal] not-italic px-[10px] py-[8px] relative w-full">
          <p className="font-['Courier_New:Bold',sans-serif] relative shrink-0 text-[#9ca3af] text-[10px] whitespace-nowrap">$ npx spryn test --story biometric-auth --acs</p>
          <p className="font-['Courier_New:Bold','Noto_Sans_Symbols2:Regular',sans-serif] relative shrink-0 text-[#4ade80] text-[10px] whitespace-pre">{`✓  AC1: Biometric prompt on login          PASS`}</p>
          <p className="font-['Courier_New:Bold','Noto_Sans_Symbols2:Regular',sans-serif] relative shrink-0 text-[#4ade80] text-[10px] whitespace-pre">{`✓  AC2: Fallback to PIN if biometric fails  PASS`}</p>
          <p className="font-['Courier_New:Bold','Noto_Sans_Symbols2:Regular',sans-serif] relative shrink-0 text-[#4ade80] text-[10px] whitespace-pre">{`✓  AC3: Session persists 30 days           PASS`}</p>
          <p className="font-['Courier_New:Bold',sans-serif] relative shrink-0 text-[#60a5fa] text-[12px] whitespace-pre">{`AC4: VoiceOver accessibility support     ▶ running…`}</p>
        </div>
      </div>
    </div>
  );
...
function FrameQiMna() {
  return (
    <div className="bg-[#1e1e2e] flex-[1_0_0] min-h-px min-w-px relative rounded-[6px]" data-name="Frame QiMNA">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[3px] items-start leading-[normal] not-italic px-[10px] py-[8px] relative w-full">
          <p className="font-['Courier_New:Bold','Noto_Sans_Symbols2:Regular',sans-serif] relative shrink-0 text-[#4ade80] text-[12px] whitespace-pre">{`✓  AC1: Biometric prompt              PASS`}</p>
          <p className="font-['Courier_New:Bold','Noto_Sans_Symbols2:Regular',sans-serif] relative shrink-0 text-[#4ade80] text-[12px] whitespace-pre">{`✓  AC2: PIN fallback flow              PASS`}</p>
          <p className="font-['Courier_New:Bold','Noto_Sans_Symbols2:Regular',sans-serif] relative shrink-0 text-[#4ade80] text-[12px] whitespace-pre">{`✓  AC3: Session persistence            PASS`}</p>
          <p className="font-['Courier_New:Bold','Noto_Sans_Symbols2:Regular',sans-serif] relative shrink-0 text-[#f87171] text-[12px] whitespace-pre">{`✗  AC4: VoiceOver - focus order skip   FAIL`}</p>
          <p className="font-['Courier_New:Regular',sans-serif] relative shrink-0 text-[#9ca3af] text-[10px] whitespace-nowrap">&nbsp;</p>
          <p className="font-['Courier_New:Bold',sans-serif] relative shrink-0 text-[#f87171] text-[12px] whitespace-pre">{`  3 passed  ·  1 failed  ·  BUG: BIO-47`}</p>
        </div>
      </div>
    </div>
  );
