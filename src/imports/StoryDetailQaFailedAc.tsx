import svgPaths from "./svg-yrcwxtdwmt";
...
function FrameMN() {
  return (
    <div className="bg-[#1e1e2e] flex-[1_0_0] min-h-px min-w-px relative rounded-[6px]" data-name="Frame mN088">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[3px] items-start leading-[normal] px-[10px] py-[8px] relative w-full">
          <p className="font-['Courier_New:Bold',sans-serif] not-italic relative shrink-0 text-[#9ca3af] text-[10px] whitespace-nowrap">$ npx spryn test --story biometric-auth --acs</p>
          <p className="font-['Courier_New:Bold','Noto_Sans:Bold',sans-serif] relative shrink-0 text-[#4ade80] text-[10px] whitespace-pre" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100, 'wght' 700" }}>{`✓  AC1: Biometric prompt on login          PASS`}</p>
          <p className="font-['Courier_New:Bold','Noto_Sans:Bold',sans-serif] relative shrink-0 text-[#4ade80] text-[10px] whitespace-pre" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100, 'wght' 700" }}>{`✓  AC2: Fallback to PIN if biometric fails  PASS`}</p>
          <p className="font-['Courier_New:Bold','Noto_Sans:Bold',sans-serif] relative shrink-0 text-[#4ade80] text-[10px] whitespace-pre" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100, 'wght' 700" }}>{`✓  AC3: Session persists 30 days           PASS`}</p>
          <p className="font-['Courier_New:Bold',sans-serif] not-italic relative shrink-0 text-[#60a5fa] text-[12px] whitespace-pre">{`AC4: VoiceOver accessibility support     ▶ running…`}</p>
        </div>
      </div>
    </div>
  );
...
function LogItem4() {
  return (
    <div className="relative rounded-[4px] shrink-0 w-full" data-name="logItem3">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[10px] items-start pl-[36px] py-[8px] relative w-full">
          <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[1.5] min-h-px min-w-px not-italic relative text-[12px] text-black">Focus ring skips the PIN fallback button entirely on error-fallback screen. Reproducible on iOS 17 and 18. Filed bug BIO-47.</p>
        </div>
      </div>
    </div>
  );
...
function FrameQiMna() {
  return (
    <div className="bg-[#1e1e2e] flex-[1_0_0] min-h-px min-w-px relative rounded-[6px]" data-name="Frame QiMNA">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[3px] items-start leading-[normal] px-[10px] py-[8px] relative w-full">
          <p className="font-['Courier_New:Bold','Noto_Sans:Bold',sans-serif] relative shrink-0 text-[#4ade80] text-[12px] whitespace-pre" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100, 'wght' 700" }}>{`✓  AC1: Biometric prompt              PASS`}</p>
          <p className="font-['Courier_New:Bold','Noto_Sans:Bold',sans-serif] relative shrink-0 text-[#4ade80] text-[12px] whitespace-pre" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100, 'wght' 700" }}>{`✓  AC2: PIN fallback flow              PASS`}</p>
          <p className="font-['Courier_New:Bold','Noto_Sans:Bold',sans-serif] relative shrink-0 text-[#4ade80] text-[12px] whitespace-pre" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100, 'wght' 700" }}>{`✓  AC3: Session persistence            PASS`}</p>
          <p className="font-['Courier_New:Bold','Noto_Sans:Bold',sans-serif] relative shrink-0 text-[#f87171] text-[12px] whitespace-pre" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100, 'wght' 700" }}>{`✗  AC4: VoiceOver - focus order skip   FAIL`}</p>
          <p className="font-['Courier_New:Regular',sans-serif] not-italic relative shrink-0 text-[#9ca3af] text-[10px] whitespace-nowrap">&nbsp;</p>
          <p className="font-['Courier_New:Bold',sans-serif] not-italic relative shrink-0 text-[#f87171] text-[12px] whitespace-pre">{`  3 passed  ·  1 failed  ·  BUG: BIO-47`}</p>
        </div>
      </div>
    </div>
  );
...
function Frame7LGer() {
  return (
    <div className="bg-[#ffefef] flex-[1_0_0] min-h-px min-w-px relative rounded-[6px]" data-name="Frame 7lGER">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[8px] items-start not-italic px-[12px] py-[8px] relative text-[#d10f19] text-[12px] w-full">
...
function Frame42() {
  return (
    <div className="relative rounded-[4px] shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center pl-[36px] py-[8px] relative w-full">
          <p className="font-['Courier_New:Bold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#1d4ed8] text-[12px] whitespace-nowrap">reporting bug to Dev agent</p>
        </div>
      </div>
    </div>
  );
...
function LogItem8() {
  return (
    <div className="relative rounded-[4px] shrink-0 w-full" data-name="logItem3">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-start pl-[36px] py-[8px] relative w-full">
          <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[1.5] min-h-px min-w-px not-italic relative text-[12px] text-black">BIO-47 acknowledged...</p>
        </div>
      </div>
    </div>
  );
...
function LogItem9() {
  return (
    <div className="relative rounded-[4px] shrink-0 w-full" data-name="logItem3">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-start pl-[36px] py-[8px] relative w-full">
          <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[1.5] min-h-px min-w-px not-italic relative text-[12px] text-black">Pulled the error-fallback screen. The PIN button has tabIndex=-1 set erroneously in the component. Quick fix, 10 minutes.</p>
        </div>
      </div>
    </div>
  );
...
function LogItem10() {
  return (
    <div className="relative rounded-[4px] shrink-0 w-full" data-name="logItem3">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-start pl-[36px] py-[8px] relative w-full">
          <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[1.5] min-h-px min-w-px not-italic relative text-[12px] text-black">Fixing focus order in error-fallback</p>
        </div>
      </div>
    </div>
  );
...
export default function StoryDetailQaFailedAc() {
  return (
    <div className="bg-[#f2f2f2] relative size-full" data-name="Story Detail - QA Failed AC">
      <Sidebar />
      <MainContentArea />
      <Frame23 />
