import svgPaths from "./svg-1qd3fm91rt";
...
function FrameEjSuh() {
  return <div className="absolute bg-[#ef4444] h-[6px] left-0 rounded-[3px] top-0 w-[102px]" data-name="Frame ejSuh" />;
}
...
function Frame23() {
  return (
    <div className="content-stretch flex gap-[10px] items-center relative shrink-0">
      <ProgTrack />
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[#ef4444] text-[12px] whitespace-nowrap">25%</p>
    </div>
  );
}
...
function BannerText() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-h-px min-w-px not-italic overflow-clip relative text-[#1d4ed8] text-[14px]" data-name="bannerText">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 whitespace-pre">{`Generating screens…  4 of 16 complete`}</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 whitespace-nowrap">{`UX Agent is generating SSO & Magic Link screens...`}</p>
    </div>
  );
}
...
export default function MilestoneOverviewModalDesigning() {
  return (
    <div className="bg-[#f2f2f2] relative size-full" data-name="Milestone Overview Modal - Designing">
      <Sidebar />
      <MainContentArea />
      <Frame19 />
