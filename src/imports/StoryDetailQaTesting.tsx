import svgPaths from "./svg-3f1quk3mwd";
...
function FrameMN() {
  return (
    <div className="bg-[#1e1e2e] flex-[1_0_0] min-h-px min-w-px relative rounded-[6px]" data-name="Frame mN088">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[3px] items-start leading-[normal] px-[10px] py-[8px] relative text-[12px] w-full">
          <p className="font-['Courier_New:Bold',sans-serif] not-italic relative shrink-0 text-[#9ca3af] whitespace-nowrap">$ npx spryn test --story biometric-auth --acs</p>
          <p className="font-['Courier_New:Bold','Noto_Sans:Bold',sans-serif] relative shrink-0 text-[#4ade80] whitespace-pre" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100, 'wght' 700" }}>{`✓  AC1: Biometric prompt on login          PASS`}</p>
          <p className="font-['Courier_New:Bold','Noto_Sans:Bold',sans-serif] relative shrink-0 text-[#4ade80] whitespace-pre" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100, 'wght' 700" }}>{`✓  AC2: Fallback to PIN if biometric fails  PASS`}</p>
          <p className="font-['Courier_New:Bold','Noto_Sans:Bold',sans-serif] relative shrink-0 text-[#4ade80] whitespace-pre" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100, 'wght' 700" }}>{`✓  AC3: Session persists 30 days           PASS`}</p>
          <p className="font-['Courier_New:Bold',sans-serif] not-italic relative shrink-0 text-[#60a5fa] whitespace-pre">{`AC4: VoiceOver accessibility support     ▶ running…`}</p>
        </div>
      </div>
    </div>
  );
