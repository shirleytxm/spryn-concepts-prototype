import svgPaths from "./svg-fm29pgn2w8";
...
function Container9() {
  return (
    <div className="relative shrink-0 w-full" data-name="Container">
      <div className="overflow-auto size-full">
        <div className="content-stretch flex flex-col gap-[4px] items-start px-[16px] py-[12px] relative w-full">
          <div className="bg-[#f5f5f5] content-stretch flex gap-[10px] items-center justify-center px-[8px] py-[6px] relative rounded-[4px] shrink-0 w-[224px]" data-name="drawer-item">
...
function Frame5() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Frame">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Frame">
          <path d={svgPaths.p2ba98600} id="Vector" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
        </g>
      </svg>
    </div>
  );
...
function Menuitem() {
  return (
    <div className="relative rounded-[4px] shrink-0 w-full" data-name="Menuitem">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[16px] items-center px-[8px] py-[6px] relative w-full">
          ...
          <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[14px] text-black whitespace-nowrap">
            <p className="leading-[20px]">Rename</p>
          </div>
        </div>
      </div>
    </div>
...
function Frame6() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Frame">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Frame">
          <path d={svgPaths.p2aa76000} id="Vector" stroke="var(--stroke-0, #E64747)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="relative rounded-[4px] shrink-0 w-full" data-name="Menuitem">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[16px] items-center px-[8px] py-[6px] relative w-full">
          <Frame6 />
          <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic overflow-hidden relative shrink-0 text-[#e64747] text-[12px] text-center text-ellipsis whitespace-nowrap">
            <p className="leading-[1.5] overflow-hidden">Delete</p>
          </div>
        </div>
      </div>
    </div>
...
function MenuItem() {
  return (
    <div className="absolute bg-white h-[74px] left-[163px] rounded-[6px] top-[179px] w-[125px]" data-name="Menu item">
      <div className="content-stretch flex flex-col gap-[2px] items-end overflow-clip p-[5px] relative rounded-[inherit] size-full">
        <Menuitem />
        <div className="h-0 relative shrink-0 w-full">
          <div className="absolute inset-[-1px_0_0_0]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 115 1">
              <line id="Line 26" stroke="var(--stroke-0, #E7E7E7)" x2="115" y1="0.5" y2="0.5" />
            </svg>
          </div>
        </div>
        <Menuitem1 />
      </div>
      <div aria-hidden="true" className="absolute border border-[#ccc] border-solid inset-0 pointer-events-none rounded-[6px] shadow-[0px_4px_6px_-1px_rgba(0,0,0,0.1),0px_2px_4px_-2px_rgba(0,0,0,0.1)]" />
    </div>
  );
}
...
export default function Component31AssetsDrawerContextMenu() {
  return (
    <div className="bg-white relative size-full" data-name="3-1_assets-drawer_context-menu">
      <Container />
      <Frame20 />
    </div>
  );
