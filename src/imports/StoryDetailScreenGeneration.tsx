import svgPaths from "./svg-how1pfbwod";
...
function CodeBox() {
  return (
    <div className="bg-[#1e1e2e] flex-[1_0_0] min-h-px min-w-px relative rounded-[6px]" data-name="codeBox">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[8px] items-start leading-[normal] px-[10px] py-[8px] relative text-[10px] w-full">
          <p className="font-['Courier_New:Bold',sans-serif] not-italic relative shrink-0 text-[#9ca3af] whitespace-nowrap">$ npx spryn generate-screens --story biometric-auth --all</p>
          <p className="font-['Courier_New:Bold',sans-serif] not-italic relative shrink-0 text-[#facc15] whitespace-nowrap">Generating: login-entry.pen</p>
          <p className="font-['Courier_New:Bold','Noto_Sans:Bold',sans-serif] relative shrink-0 text-[#4ade80] whitespace-pre" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100, 'wght' 700" }}>{`login-entry.pen  created  (2.1s) ✓  `}</p>
          <p className="font-['Courier_New:Bold',sans-serif] not-italic relative shrink-0 text-[#facc15] whitespace-nowrap">Generating: biometric-prompt.pen</p>
          <p className="font-['Courier_New:Bold','Noto_Sans:Bold',sans-serif] relative shrink-0 text-[#4ade80] whitespace-pre" style={{ fontVariationSettings: "'CTGR' 0, 'wdth' 100, 'wght' 700" }}>{`biometric-prompt.pen  created  (1.8s) ✓`}</p>
          <p className="font-['Courier_New:Bold',sans-serif] not-italic relative shrink-0 text-[#3b82f6] whitespace-nowrap">Generating: success-state.pen</p>
          <p className="font-['Courier_New:Bold',sans-serif] not-italic relative shrink-0 text-[#60a5fa] whitespace-nowrap">running…</p>
        </div>
      </div>
    </div>
  );
