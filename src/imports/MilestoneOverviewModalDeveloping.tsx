import svgPaths from "./svg-0gi8h4w97p";
...
function FrameEjSuh() {
  return <div className="absolute bg-[#22c55e] h-[6px] left-0 rounded-[3px] top-0 w-[278px]" data-name="Frame ejSuh" />;
}
...
function Frame26() {
  return (
    <div className="content-stretch flex gap-[10px] items-center relative shrink-0">
      <ProgTrack />
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[#008330] text-[12px] whitespace-nowrap">72%</p>
    </div>
  );
}
...
function Frame63() {
  return (
    <div className="h-[18.32px] relative shrink-0 w-[12.228px]">
      <div className="absolute inset-[0_-1.64%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12.628 18.32">
          <g id="Frame 219199557">
            <path d={svgPaths.p2a514b80} fill="var(--fill-0, #1D4ED8)" id="Text" stroke="var(--stroke-0, #1D4ED8)" strokeWidth="0.2" />
          </g>
        </svg>
      </div>
    </div>
...
function BannerText() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-h-px min-w-px not-italic overflow-clip relative text-[#1d4ed8] text-[14px]" data-name="bannerText">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 whitespace-pre">{`Testing in progress  —  12 of 16 ACs passed`}</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 whitespace-nowrap">{`QA Agent is running acceptance criteria for SSO & Magic Link`}</p>
    </div>
  );
}
...
function PreviewBanner() {
  return (
    <div className="bg-[#e5f1ff] relative rounded-[8px] shrink-0 w-full" data-name="previewBanner">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[12px] items-center px-[14px] py-[12px] relative w-full">
          <Frame58 />
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[#bfdbfe] border-solid inset-[-1px] pointer-events-none rounded-[9px]" />
    </div>
  );
}
...
function BannerText1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-h-px min-w-px not-italic overflow-clip relative text-[#1d4ed8] text-[14px] whitespace-nowrap" data-name="bannerText">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[normal] relative shrink-0">Implementing Stories...</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0">Developer Agent is working on Biometric Login...</p>
    </div>
  );
}
...
function Frame65() {
  return (
    <div className="bg-[#f5f9ff] relative rounded-[8px] shrink-0 w-full">
      ...
      <div className="content-stretch flex flex-col gap-[12px] items-start p-[12px] relative w-full">
        <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[#374151] text-[14px] w-full">
          <p className="leading-[20px]">Multiple agents are working simultaneously</p>
        </div>
        <PreviewBanner />
        <PreviewBanner1 />
      </div>
...
function Frame62() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-[85px]">
      <Frame25 />
      <Frame34 />
    </div>
  );
...
export default function MilestoneOverviewModalDeveloping() {
  return (
    <div className="bg-[#f2f2f2] relative size-full" data-name="Milestone Overview Modal - Developing">
      <Sidebar />
      <MainContentArea />
      <Frame22 />
