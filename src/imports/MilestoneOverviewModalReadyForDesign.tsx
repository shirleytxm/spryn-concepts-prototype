import svgPaths from "./svg-y89dbjus0d";
...
function BannerText() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-h-px min-w-px overflow-clip relative text-[14px]" data-name="bannerText">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 text-[#065f46]">Requirements are shaped for all deliverables</p>
      <div className="font-['Inter:Regular',sans-serif] font-normal leading-[0] relative shrink-0 text-[#008330]">
        <p className="leading-[1.5] mb-0">All stories reviewed by agents — screens are ready to be generated</p>
        <ul>
          <li className="list-disc ms-[21px]">
            <span className="leading-[1.5]">16 screens across 4 stories</span>
          </li>
        </ul>
      </div>
    </div>
...
function Frame54() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[12px] items-start min-h-px min-w-px not-italic relative whitespace-nowrap">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 text-[#065f46] text-[16px]">✓</p>
      <BannerText />
    </div>
  );
}
...
function Btn() {
  return (
    <div className="bg-[#16a34a] content-stretch flex flex-col items-center justify-center overflow-clip px-[20px] py-[12px] relative rounded-[8px] shrink-0" data-name="btn">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[14px] text-white whitespace-nowrap">Generate Screens</p>
    </div>
  );
}
...
export default function MilestoneOverviewModalReadyForDesign() {
  return (
    <div className="bg-[#f2f2f2] relative size-full" data-name="Milestone Overview Modal - Ready for Design">
      <Sidebar />
      <MainContentArea />
      <Frame19 />
